...
always_comb begin
    if(coordinate[NARROW_WIDTH*2-1:NARROW_WIDTH*2-1-INTEGER_BITS] == {(INTEGER_BITS+1){1'b0}}) flag = 0;
    else if(coordinate[NARROW_WIDTH*2-1:NARROW_WIDTH*2-1-INTEGER_BITS] == {(INTEGER_BITS+1){1'b1}}) flag = 0;
    else flag = 1;
end
