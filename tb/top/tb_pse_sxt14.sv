...
module tb_pse_sxt14;
    ...
    initial begin
        ...
        $display("\n  Writing CSVs...");
        dump_bram_csv("sim/render/sxt14_bram.csv");
        dump_bram_direct_csv("sim/render/sxt14_bram_direct.csv");
        dump_dram_csv("sim/render/sxt14_dram.csv");
        dump_image_csv("sim/render/sxt14_image.csv", BASE);
